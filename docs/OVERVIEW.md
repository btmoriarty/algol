...
- `compose_adapter.py`: parses and normalizes results from `evidence-locked-uat` and `applying-formal-rigor`. Routing to those sources is declared in policy and recommended by `router.py`.
